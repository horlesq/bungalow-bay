...
export default function Bungalow({ bungalow, goBackButton }) {
    ...
    return (
        <div className="max-w-7xl mx-auto pb-10 sm:pb-16 lg:pb-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 xl:gap-20 border border-primary-800 rounded-xl p-6 sm:p-8 lg:p-10 mb-16 sm:mb-20 lg:mb-24">
