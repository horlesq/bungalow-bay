    ...
    return (
        <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
            <div className="col-span-3">
                ...
                <div className="space-y-8">
                    <p>
                        ...
                        it's not just about the luxury bungalows. It's about the
                        experience of reconnecting with nature and enjoying
                        simple pleasures with family.
                    </p>
                    <p>
                        Our 8 luxury bungalows provide a cozy base, but the real
            ...
            <div className="col-span-2">
                <img
                    src="/about-1.jpg"
                    alt="Family sitting around a fire pit in front of bungalow"
                />
            </div>
